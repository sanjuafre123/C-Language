...
main() 
{
   ...
   switch(a)
   {
   	 ...
   	 int lan;
   	 printf("you Enter 1 For English And 2 enter For Hindi : \n");
     scanf("%d",&lan);
     ...
     switch(lan)
     {
     	...
     	case 2 : printf("Hindi");
		break;
		default : printf("Enter The Value 1 to 2"); 
	 }
   	 break;
	 ...
	 break;
   	 ...
   	 case 3 : printf("internet connection\n");
   	 int net;
   	 printf("Enter  enter interner problems \n");
   	 printf("\n1. slow speed");
	 ...
	 break;
		...
		break;
		case 3 : printf("Rs. 2199 - For 1 Year");
		break;
		default : printf("Enter The Value 1 to 3");
	 }
	 break;
	 default : printf("Enter The Value 1 to 4");
